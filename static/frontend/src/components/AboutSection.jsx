      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-6">
        ...
        <div className="space-y-6 z-10 relative lg:ml-16 md:ml-10">
          <h2 className="text-5xl font-extrabold tracking-wide">
            {t("AboutTitle")} <span className="text-black dark:text-gray-100 font-extrabold curved-wecast">WeCast</span>
          </h2>

          <p className="text-lg leading-relaxed max-w-lg text-neutral-800 dark:text-gray-300">
            {t("AboutParagraph1")}
          </p>
          ...
          <p className="text-lg leading-relaxed max-w-lg italic text-neutral-700 dark:text-gray-400">
            {t("AboutQuote")}
          </p>
        </div>
