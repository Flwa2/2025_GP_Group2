...
export default function Preview() {
    ...
    useEffect(() => {
        ...
        // 2) Fallback: backend last audio (optional)
        if (!saved) {
    ...
    const seekTo = (sec) => {
        // We can seek by forcing time through the player (simplest approach):
        // Keep it simple: store a "requestedSeek" state if you want.
        // But easiest: add a prop in WeCastAudioPlayer for "externalSeek".
    };
        ...
        <div className="min-h-screen bg-cream dark:bg-[#0a0a1a] text-black dark:text-white px-6 py-10 transition-colors duration-500">
            <div className="max-w-[1400px] mx-auto space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-extrabold">Preview</h1>
                    ...
                    <div className="lg:col-span-5">
                        <div className="rounded-3xl border border-neutral-200 dark:border-neutral-800 bg-white/95 dark:bg-neutral-900/95 p-5 shadow-lg">
                            ...
                            <div className="mt-3 text-[11px] text-black/50 dark:text-white/50">
                                Auto-scroll pauses when you interact
                            </div>
                        </div>
                    </div>
                </div>
