...
export default function HowItWorks() {
  ...
  return (
    <section className="bg-[#e9e2ff] text-black transition-colors duration-500 dark:bg-[#0a0a1a] dark:text-white">
      <div className="section-shell section-block min-w-0 py-12 sm:py-16 md:py-20">
        ...
        <ol className="mt-8 grid min-w-0 grid-cols-1 gap-5 sm:mt-10 sm:gap-6 md:grid-cols-3 md:gap-5 lg:gap-6">
          <StepCard
            delay={0}
          ...
          >
            <div className="absolute -start-2 -top-2 grid h-9 w-9 place-items-center rounded-full bg-black text-lg font-bold text-white dark:bg-white dark:text-black">
              1
            </div>
